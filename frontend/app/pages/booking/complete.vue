  ...
  <div class="h-[100dvh] overflow-hidden bg-gray-50 flex flex-col">
    ...
    <main class="flex-1 overflow-y-auto px-5 py-4">
      ...
      <div class="flex flex-col items-center justify-center mb-8 text-center animate-fade-in-up">
        ...
        <p class="text-gray-500 text-sm">예매번호 <span class="font-bold text-gray-900">T-20241024-8842</span></p>
      </div>

      <!-- Ticket Card -->
      <div class="bg-white overflow-hidden shadow-xl shadow-gray-200/60 border border-gray-100 relative mx-2 rounded-3xl">
          ...
          <div class="p-8 border-b border-gray-100 border-dashed relative">
              <div class="flex flex-col items-center text-center mb-8">
                  ...
                  <div>
                      <h3 class="text-xl font-bold text-gray-900 leading-tight mb-2">네온 나이츠 월드 투어 2024</h3>
              ...
              <div class="space-y-4 pt-2">
                 <div class="flex justify-between items-center">
                      ...
                      <span class="text-base font-bold text-gray-900">2024년 10월 24일 19:00</span>
                 </div>
                 <div class="flex justify-between items-center">
                      <span class="text-sm text-gray-400 font-medium">매수</span>
                      <span class="text-base font-bold text-gray-900">2매</span>
                 </div>
              </div>
          </div>
          ...
          <div class="p-8 bg-gray-50/50">
               ...
               <div class="space-y-3 mb-8">
                   <div class="flex justify-between items-center p-4 bg-white rounded-2xl border border-gray-200">
                       <span class="text-sm font-bold text-gray-900">VIP A구역 12열 04번</span>
                       <span class="text-xs font-medium text-gray-500">150,000원</span>
                   </div>
                   <div class="flex justify-between items-center p-4 bg-white rounded-2xl border border-gray-200">
                       <span class="text-sm font-bold text-gray-900">VIP A구역 12열 05번</span>
                       <span class="text-xs font-medium text-gray-500">150,000원</span>
                   </div>
               </div>
               ...
               <div class="flex justify-between items-end">
                  <div class="flex flex-col gap-1 mt-4">
                      ...
                      <span class="text-xs text-gray-500 font-medium">현대카드 (일시불)</span>
                  </div>
                  <span class="text-2xl font-bold text-indigo-600 tracking-tight">302,000원</span>
               </div>
          </div>
      </div>
